...
if __name__ == "__main__":
  ...
  for model,name in zip(models,names):
    ...
    trainingDiagnostics(histories,outdir,'/%s_learning_curve.png'%name)
    print("Accuracy mean and spread")
    print (val_accuracies)
    performanceSummary([val_accuracies],[name],outdir,outname='/%s_performance_summary.png'%name)
  
  print(len(val_accuracies_all))
  print(len(names)             )
  performanceSummary(val_accuracies_all,names,outdir,outname='/allModels_performance_summary.png')